...
func AnalysisAndGenerate(packetChan chan structs.CombineHttpRecord, filepath string){
...
func combineHttp(packet gopacket.Packet, reqMap map[structs.PacketKey]structs.CombineHttpRecord) structs.PcapStruct{
